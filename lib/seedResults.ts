...
export const SEED_RESULTS: Partial<Record<GameId, GameResult>> = {
  ...
  // Premier G8 — Wed 3:00 PM · F9 · P27 (loserOf g4) vs PDG (winnerOf g6)
  'premier.g8': {
    winner: 'premier.PDG',
    awayScore: null,
    homeScore: null,
  ...
  // Premier G11 — Thu 1:30 PM · F10 · TNXL (winnerOf g10) vs WSA (loserOf g9)
  'premier.g11': {
    winner: 'premier.TNXL',
    awayScore: null,
    homeScore: null,
  ...
  // Prospect G10 — Wed 3:00 PM · F11 · ECA (winnerOf g8) vs TNXL (loserOf g4)
  'prospect.g10': {
    winner: 'prospect.ECA',
    awayScore: null,
    homeScore: null,
  ...
  // Prospect G15 — Thu 1:30 PM · F9 (WB Final) · CPCA (winnerOf g11) vs A3 (winnerOf g12)
  'prospect.g15': {
    winner: 'prospect.A3',
    awayScore: null,
    homeScore: null,
  ...
  // Varsity G9 — Wed 12:15 PM · F14 · WSA (winnerOf g7) vs FTB (loserOf g3)
  'varsity.g9': {
    winner: 'varsity.FTB',
    awayScore: null,
    homeScore: null,
  ...
  // Varsity G12 — Wed 12:15 PM · F13 · KINGS (winnerOf g4) vs CLUB (winnerOf g6)
  'varsity.g12': {
    winner: 'varsity.CLUB',
    awayScore: null,
    homeScore: null,
  ...
  // Varsity G14 — Thu 11:00 AM · F14 · P27 (winnerOf g10) vs CPCA (loserOf g11)
  'varsity.g14': {
    winner: 'varsity.P27',
    awayScore: null,
    homeScore: null,
  ...
  // Varsity G13 — Thu 11:00 AM · F13 · FTB (winnerOf g9) vs KINGS (loserOf g12)
  'varsity.g13': {
    winner: 'varsity.FTB',
    awayScore: null,
    homeScore: null,
  ...
  // Varsity G15 — Thu 1:30 PM · F12 (WB Final) · GPA (winnerOf g11) vs CLUB (winnerOf g12)
  'varsity.g15': {
    winner: 'varsity.GPA',
    awayScore: null,
    homeScore: null,
  ...
  // Varsity G16 — Thu 1:30 PM · F14 · FTB (winnerOf g13) vs P27 (winnerOf g14)
  'varsity.g16': {
    winner: 'varsity.FTB',
    awayScore: null,
    homeScore: null,
  ...
  // JV Final — Thu 12:30 PM · F1 · A3 MS (winnerOf g7) vs TNXL (winnerOf g9)
  // LB side (TNXL) wins → IF game activates.
  'jv.fin': {
    winner: 'jv.TNXL',
    awayScore: null,
    homeScore: null,
