...
const PARTICIPANTS: Participant[] = [
  ...
  { order: 8,  academy: 'CPCA',       player1: 'Jean Verdejo',       player2: 'Abdiel Castillo'   },
...
const ROTATION: RotationRow[] = [
  ...
  { battingTeam: 'CPCA',       hitters: 'Jean Verdejo / Abdiel Castillo',      shagTeam: 'GA Premier', retrievalTeam: 'A3',         hypeTeam: 'CPCA'       },
